...
const BuyerBid = () => {
  ...
  function MyVerticallyCenteredModal3(props) {
    ...
    const fetchTransacation = async () => {
      try {
        const { data } = await axios.get(`https://djqtflksic.execute-api.ap-south-1.amazonaws.com/dev/createbid/payment/placeBid/${bidId}`)
        setTransData(data);
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <Button onClick={() => {
                        ...
                        setBidId(i._id);setModalShow2(true)}} >View</Button>
                    </td>
                    <td>
                      <i
