...
import { MdDashboardCustomize, MdPending } from "react-icons/md";
...
const Dashboard = () => {
  const card = [
    ...
    },
    {
      ...
      number: "150",
      icon: (
        <MdDashboardCustomize className="text-2xl text-[#ffb64d]" />
      ),
      bg : "#ffb64d"
    },
    {
      ...
      number: "150",
      icon: (
        <MdDashboardCustomize className="text-2xl text-[#232b4b]" />
      ),
      bg : "#232b4b"
    },
    {
      ...
      number: "150",
      icon: (
        <MdDashboardCustomize className="text-2xl text-[#5b63d3]" />
      ),
      bg : "#5b63d3"
    },
  ];
