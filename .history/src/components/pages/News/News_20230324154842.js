...
const News = () => {
  ...
  function AddRatesModal(props) {
    ...
    const postData = async (e) => {
      e.preventDefault();
      try {
        const { data } = await axios.post("http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:4002/auth/addNews/" , {photo : img , message , link })
        fetchData();
        props.onHide();
      } catch (e) {
        console.log(e);
