...
const Dashboard = () => {
  ...
  const fetchSupplier = async () => {
    try {
      const { data } = await axios.get(
        "https://djqtflksic.execute-api.ap-south-1.amazonaws.com/dev/admin/supplierz"
      );
    } catch (e) {
      console.log(e);
    }
  ...
  const card = [
    ...
    },
    {
      ...
      number: "150",
      icon: <MdPending className="text-2xl text-[#ffb64d]" />,
      bg: "#ffb64d",
    },
    {
      progress: "bg-yellow-400",
    ...
    },
    {
      ...
      number: "150",
      icon: <MdIncompleteCircle className="text-2xl text-[#5b63d3]" />,
      bg: "#5b63d3",
    },
  ];
  return (
