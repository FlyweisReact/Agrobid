    ...
    <>
      ...
      <div>
        <div className="sup">
          ...
          <div className="mid">
            <p>Name : {UserName} </p>
            <p>Phone Number: {data?.data?.[1]?.user?.tradeName} </p>
            <p>Address :  {data?.data?.[1]?.user?.tradeName} </p>
            <p>Email :  {data?.data?.[1]?.user?.tradeName}  </p>
            <p>Trade Name :  {data?.data?.[1]?.user?.tradeName}  </p>
            <p>Role :   {data?.data?.[1]?.user?.tradeName} </p>
          </div>
          <div className="mid">
