  ...
  const fetchData = async (e) => {
    try {
      const { data } = await axios.get(
        "https://ajeet-backend-new.vercel.app/api/v1/mandi/all"
      );
      setData(data);
    ...
    const postData = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          "https://ajeet-backend-new.vercel.app/api/v1/mandi/add",
    ...
    const EditHandler = async (e) => {
      ...
      try {
        const { data } = await axios.put(
          `https://ajeet-backend-new.vercel.app/api/v1/mandi/update/${id}`,
          { product, location, date, arrival, minPrice, maxPrice }
        );
        console.log(data);
        fetchData();
  ...
  const deleteHandler = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://ajeet-backend-new.vercel.app/api/v1/mandi/delete/${id}`
      );
      console.log(data);
      fetchData();
