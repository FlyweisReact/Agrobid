      ...
      {role === "Supplier" ? (
        ...
        <div>
          <div className="sup">
            <div className="left">
              <img
                src="ttps://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2080&q=80h"
                alt=""
                style={{ width: "100%" }}
              />
            </div>
