...
const BuyerBid = () => {
  ...
  function MyVerticallyCenteredModal3(props) {
    ...
    const fetchTrnsaction = async () => {
      try {
        const { data } = await axios.get(`https://djqtflksic.execute-api.ap-south-1.amazonaws.com/dev/createbid/payment/placeBid/6448f1ac20e930d6a5049c8b`)
        setTransData(data)
      }catch(e) { 
         console.log(e)
      }
