...
const Service = () => {
  ...
  const deleteHandler = async (id) => {
    try{
      const { data } = await axios.delete(`https://djqtflksic.execute-api.ap-south-1.amazonaws.com/dev/transport/${id}`)
            ...
            <tr key={index}>
              ...
              <td>
                <div style={{ display: "flex", gap: "10px" }}>
                  ...
                  />
                  <i class="fa-solid fa-trash" style={{color : 'red' , cursor : 'pointer'}} onClick={() => } ></i>
                </div>
              </td>
            </tr>
          ))}
