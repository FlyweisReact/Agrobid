...
const Service = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postData = async () => {
        try{
          const { data } = await axios.post(`http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:4002/transport/${setTID}` , {vehicleNumber , currentLocation , attachFleet , capacity})
        }catch(e) { 
          console.log(e)
        }
    }
