...
const Detail = [
  {
    ...
    Gst: "4515AADSCFDF45",
    Trade: "React1",
    rc : 'https://static.toiimg.com/thumb/resizemode-4,msid-94154821,imgsize-68152,width-720/94154821.jpg'
  },
  {
    name: "React",
    adhaar:
        ...
        <tbody>
          {Detail.map((i, index) => (
            <tr key={index}>
              ...
              <td>
                {" "}
                <img src={i.rc} alt="" className="fast-food" />{" "}
              </td>
            </tr>
          ))}
        </tbody>
