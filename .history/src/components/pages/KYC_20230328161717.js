      ...
      <div>
        <div className="sup">
          ...
          <div className="mid">
            ...
            <p>Pan Number :{data?.data?.[1]?.aadharNumber} </p>
            <p>City :{data?.data?.[1]?.aadharNumber} </p>
            <p>District :{data?.data?.[1]?.aadharNumber}  </p>
            <p>Gst Number :{data?.data?.[1]?.aadharNumber}  </p>
            <p>Pin Code : {data?.data?.[1]?.aadharNumber}  </p>
            <p>State :{data?.data?.[1]?.aadharNumber}  </p>
          </div>
          <div className="right">
