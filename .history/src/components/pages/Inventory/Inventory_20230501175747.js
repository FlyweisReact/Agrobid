        ...
        <Modal.Body>
          <Form onSubmit={postHandler}>
            ...
            <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
              ...
              <img src='https://www.pngarts.com/files/3/Plus-Symbol-PNG-Image-with-Transparent-Background.png' alt='' style={{width : '30px' , cursor : 'pointer'}} onClick={() => handleAddButtonClick2()} />
            </div>
