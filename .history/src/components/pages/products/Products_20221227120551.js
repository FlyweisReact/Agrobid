...
const Products = () => {
  ...
  const SearchData = data2.filter(
    (i) =>
      i?.LotId.includes(search?.toLowerCase()) ||
  ...
  const BoxData = data.filter((i) =>
    i?.Status?.toLowerCase().includes(box?.toLowerCase())
  );
        ...
        <>
          ...
          >
            ...
            <div className="specialDiv">
              <p onClick={() => setBox(null)}>All</p>
              <p onClick={() => setBox("Pending")}>Pending</p>
              <p onClick={() => setBox('Live')}>Live</p>
              <p onClick={() => setBox('Approved')}>Approved</p>
              <p onClick={() => setBox('Expired')}>Expired</p>
              <p onClick={() => setBox('Positive')}>Positive</p>
              <p onClick={() => setBox('Loading Awaited')}>Loading Awaited</p>
              <p onClick={() => setBox('In Transit')}> In Transit</p>
              <p onClick={() => setBox('Delivered')}>Delivered</p>
            </div>
          </div>
        </>
      ) : (
